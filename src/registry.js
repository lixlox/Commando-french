...
class CommandoRegistry {
  ...
  registerDefaultCommands(commands = {}) {
    ...
    if (commands.aide) this.registerCommand(require("./commands/util/aide"));
    if (commands.prefixe)
      this.registerCommand(require("./commands/util/prefixe"));
    ...
    if (commands.commandState) {
      this.registerCommands([
        require("./commands/commands/groupes"),
        require("./commands/commands/activer"),
        require("./commands/commands/desactiver"),
        require("./commands/commands/recharger"),
        require("./commands/commands/charger"),
        require("./commands/commands/decharger"),
      ]);
    }
    return this;
  }
